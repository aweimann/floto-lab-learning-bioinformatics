...
exampleDT <- data.table(Cell_type = c("A","A","A","A","A","A","A","A","A","A","B","B","B","B","B","B","B","B","B","B"), Sample = c("Sample1","Sample2","Sample3","Sample4","Sample5","Sample6","Sample7","Sample8","Sample9","Sample10","Sample1","Sample2","Sample3","Sample4","Sample5","Sample6","Sample7","Sample8","Sample9","Sample10"), Measurement1 = c(1.2,1.4,2.5,2.7,1.6,2.4,2.2,1.9,1.4,1.5,2.1,2.4,2.7,2.6,3.1,1.9,2.8,2.7,2.3,2.2), Measurement2 = c(1.4,1.5,2.2,2.8,1.5,2.5,2.2,1.7,1.4,1.5,2.2,2.9,2.4,2.1,2.9,1.7,2.6,2.2,2.2,2.5)) #Creates a data table by hand
...
We keep rows only if they're Cell_type A and the match the criteria in the (). We've actually got two criteria in the brackets, each containing two criteria. Both measurements need to be greater than 2.5 or less than 2.0.
